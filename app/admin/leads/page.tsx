...
function AISummaryPanel({ lead }: { lead: Lead }) {
  ...
  return (
    <BentoCard className="p-5 relative overflow-hidden col-span-1 sm:col-span-2 lg:col-span-12">
      <div
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1440px] px-4 py-4 lg:px-8 lg:py-6">
        ...
        {/*
          Mobile:  1 column
          Tablet:  2 columns
          Desktop: 12 columns (original layout preserved exactly)
        */}
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-12">
          {/* Stats */}
          <BentoCard className="p-5 flex flex-col justify-between min-h-[100px] lg:col-span-3">
          ...
          <BentoCard className="p-5 flex flex-col justify-between min-h-[100px] relative overflow-hidden lg:col-span-3">
          ...
          {/* Search & Nav */}
          <BentoCard className="p-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:col-span-2 lg:col-span-12">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
              ...
              <div
                className="flex h-9 items-center rounded-xl bg-white/[0.05] px-3 gap-2 sm:min-w-[18rem]"
                style={{ border: "1px solid rgba(255,255,255,0.04)" }}
              >
                <svg
          ...
          {!lead ? (
            ...
            <>
              {/* Identity */}
              <BentoCard className="p-6 relative overflow-hidden sm:col-span-2 lg:col-span-5">
                <div
              ...
              {/* Score ring */}
              <BentoCard className="p-5 flex flex-col items-center justify-center gap-3 lg:col-span-2">
              ...
              {/* Package / Value */}
              <BentoCard className="p-5 flex flex-col justify-between lg:col-span-2">
                <div>
                  <Label>Package</Label>
              ...
              {/* Next action */}
              <BentoCard className="p-5 flex flex-col justify-between relative overflow-hidden sm:col-span-2 lg:col-span-3">
                ...
                <div
                  className="mt-4 flex gap-1.5 overflow-x-auto pb-1 -mx-1 px-1"
                  style={{ scrollbarWidth: "none" }}
                >
                  {lead.email && (
                    <GhostBtn
                  ...
                  {lead.phone && (
                    <a
                      ...
                      className="inline-flex h-9 shrink-0 items-center justify-center rounded-xl bg-white/[0.05] px-4 text-xs font-medium text-white/75 transition-all hover:bg-white/[0.1] hover:text-white"
                    >
                      WhatsApp
                    </a>
                  )}
                  <GhostBtn className="shrink-0" onClick={() => copyLead(lead)}>
              ...
              {/* Contact details */}
              <BentoCard className="p-5 sm:col-span-2 lg:col-span-4">
                  ...
                  >
                    ...
                    {label === "Website" && value ? (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-xs text-cyan-300 hover:text-cyan-200 truncate max-w-[55vw] sm:max-w-[180px]"
                      >
                        {value}
                      </a>
                    ) : (
              ...
              {/* Quick replies */}
              <BentoCard className="p-5 sm:col-span-2 lg:col-span-8">
              ...
              {/* Notes */}
              <BentoCard className="p-5 sm:col-span-2 lg:col-span-12">
                <div className="flex items-center justify-between mb-3">
